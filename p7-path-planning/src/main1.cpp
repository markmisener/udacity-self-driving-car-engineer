                    ...
                    if (s != "") {
                        ...
                        if (event == "telemetry") {
                            ...
                            for (int i = 0; i < sensor_fusion.size(); i++) {
                                ...
                                } else if ((check_car_lane != lane) && (check_car_s < car_s) &&
                                           (car_s - check_car_s) < 20.0) {
                                    candidateLane[check_car_lane] = false;
                                }
                            ...
                            vector<double>
                                    next_wp0 = getXY(car_s + 30, (2 + 4 * lane), map_waypoints_s, map_waypoints_x,
                                                     map_waypoints_y);
                            vector<double>
                                    next_wp1 = getXY(car_s + 60, (2 + 4 * lane), map_waypoints_s, map_waypoints_x,
                                                     map_waypoints_y);
                            vector<double>
                                    next_wp2 = getXY(car_s + 90, (2 + 4 * lane), map_waypoints_s, map_waypoints_x,
                                                     map_waypoints_y);
